...
#----Train----
def train(actor, actor_optim, critic, critic_optim, num_episodes, gamma=0.99, print_interval=500, eval_interval=2500):
    for episode in range(num_episodes):
        ...
        for t in range(10):
            ...
            reward = (((raw_reward - 3.5) * 3) ** 5) / (7.5 ** 5)
            if raw_reward >= 4:
    ...
    torch.save(actor.state_dict(), "trained_actor.pt")
